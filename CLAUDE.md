...
최초 작성: 2026-09-07
최종 갱신: 2026-09-16 (4-1절에 7단계. 사용자 병합 승인 뒤 done 행을 작업 브랜치 마지막 커밋으로 얹고 기록 브랜치를 열지 않는다. 이슈 180)
...
### 2-1. 답변 형식 (2026-09-08 신설, 같은 날 규격 분리. 2026-09-14 R5)
...
### 3-1. project-sync 반입 절차 (2026-09-08 신설. 2026-09-10 본문을 10-15로 내림)

project-sync는 프로젝트 계열 원본 사본이고 모델은 여기에 직접 쓸 수 없다. .claude/settings.json의 deny가 막는다. 반입 후보를 만들 때, 전사본의 지위를 적을 때, project-sync 아래 낡은 경로를 발견했을 때 harness/docs/10-15 2절을 연다. 네 단계 절차와 따라 오는 제약 둘이 거기 있다.
