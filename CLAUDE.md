...
최초 작성: 2026-09-07
최종 갱신: 2026-09-10 (4절과 4-1절. union이 서버 병합에 안 걸리는 것을 반영하고 PR 전 병합 단계를 넣음)
...
### 4-1. 작업 흐름 (2026-09-08 신설. 2026-09-10 settings 이유 표를 10-15로 내리고 5단계 신설)
...
| 4 | 검사를 돌리고 결과를 기록한다 |
| 5 | 브랜치에서 origin/main을 병합한다. 기록 파일의 union 병합은 로컬에서만 걸린다 |
