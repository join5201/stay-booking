...
최초 작성: 2026-09-07
최종 갱신: 2026-09-21 (3절 .claude 행에 스킬 폴더 o2o-harness. 2-1절과 3-1절에 스킬 포인터. 이슈 189)
...
### 2-1. 답변 형식 (2026-09-08 신설, 같은 날 규격 분리. 2026-09-14 R5. 2026-09-21 스킬)
...
| README.md | 저장소 소개 |
| .claude/ | 도구 설정과 스킬 폴더. settings.json, hooks, skills/o2o-harness/ 아래 절차 스킬 넷(round, progress-row, approval-request, guarded-paths) |
