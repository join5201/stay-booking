...
최초 작성: 2026-09-08
최종 갱신: 2026-09-23 (마스터 프롬프트 행의 round 스킬 경로. 이슈 192. 그 전 2026-09-21 dev-ptcf-prompt.v3.md 행 추가. 마스터 프롬프트 행에 round 스킬 이관. 이슈 189)
...
| 마스터 프롬프트 | 세션 첫 턴에 붙이던 것. 07, harness-ptcf 둘, dev-ptcf 둘 | 2026-09-21부터 첫 턴 절차 T1부터 T5와 단계 선택표는 .claude/skills/round 스킬이 대신한다. Context 절은 작성 시점 상태라 이력이다. 07 v3만 설계 단계용으로 남는다 |
