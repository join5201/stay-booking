...
최초 작성: 2026-09-07
최종 갱신: 2026-09-23 (지위 줄의 round 스킬 경로. 이슈 192. 그 전 2026-09-21 지위 줄 추가. 5절 선택표의 정본이 round 스킬로. 그 전 2026-09-07 v2 템플릿 자율 선택 반영)
지위 (2026-09-21): 5절 실행 단계 선택표의 정본은 .claude/skills/round/SKILL.md로 옮겼다. 1절과 3절은 준비 단계 이력이다. 본문은 고치지 않는다(이슈 189. 경로는 이슈 192)
...
| G1 통과, 계약의 평가 대상 행이 생성 후 기입이 아니라 실제 경로로 채워짐, harness/reviews/task-S{S}-R{R}-A.md 또는 -B.md 없음 | harness/prompts/evaluate.md 두 벌 | A용, B용 평가 요청을 채워 harness/out/task-S{S}-R{R}/evaluate-A.md, evaluate-B.md 저장. 허용 입력 파일을 harness/out/task-S{S}-R{R}/eval-input/ 에 복사(HR1 목록만). 평가 기준 파일 경로 지정 | 정지. "평가 요청 2벌 준비 완료. Codex 새 작업 둘에 전달하고 리포트를 harness/reviews/에 넣어 달라." |
