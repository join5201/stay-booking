...
## 지금 상태 (2026-09-25 하네스 행에 CI. 2026-09-23 스킬 경로. 같은 날 설계 Step 9 행과 백엔드 행)
...
| 하네스 H0부터 H6 | 완료. 검사기와 양식과 기록 규칙과 작업 계약이 다 있다. 반복 절차는 스킬 폴더 [.claude/skills](../.claude/skills/README.md)의 스킬 넷(round, progress-row, approval-request, guarded-paths)이 연다(PR 190, PR 193). PR과 main push마다 [.github/workflows/ci.yml](../.github/workflows/ci.yml)이 백엔드 테스트와 검사기를 돌린다(PR 212) |
