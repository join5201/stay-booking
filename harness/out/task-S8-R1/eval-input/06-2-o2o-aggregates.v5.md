...
최종 갱신: 2026-09-08 v5 (08-3 결정 11건 반영: Payment 내부 요소에 정산 표식과 시도 필드 C-1과 C-4, 커맨드 23 C-11, 전역 잠금 순서 C-2, 취소 경로 순서 C-12, CRC에 PaymentApplicationService 신설 C-4, 내부 메서드 시그니처 C-9)
