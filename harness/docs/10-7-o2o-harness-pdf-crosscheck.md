...
최초 작성: 2026-09-07
최종 갱신: 2026-09-23 (1-4절 주의 스킬 경로. 이슈 192. 그 전 2026-09-21 1-4절에 전제가 사라졌다는 주. 이슈 189. 그 전 2026-09-07 v1)
...
### 1-4. PDF는 전부 Claude Code 교재라 설정 키와 명령은 하나도 이식되지 않는다 (2026-09-21 주. 2026-09-23 경로)
...
2026-09-21 주: 이 절의 전제는 10-4 1절이 API 기반 Java 하네스를 보류하고 생성을 Claude Code 앱에서 하기로 하면서 사라졌다. settings.json과 hooks는 2026-09-10부터, 스킬은 2026-09-21부터 실제로 쓴다(.claude/skills, 이슈 189와 192). 아래 표의 기능 열은 그 시점 판정이라 그대로 둔다.
