...
## 4. 입력과 적용 규칙 (2026-09-16 라운드 준비에서 평가 기준 해시와 명세 11 해시 갱신. 같은 날 앞서 T10 뒤 해시 둘 갱신. 그 앞서 T5와 T3에서 갱신)
...
| 대상 11 API 명세 | document/11-o2o-api-spec.md | sha256:9822c14edc59223f | 2026-09-16 PR 185 뒤 갱신(결제 승인의 시각 기준 여섯 자리. API 형태와 필드는 그대로). 공통 절 전부(28행부터 156행), API 32개 절 각각의 요청 표와 응답과 오류 표와 처리 규칙, 응답 모델 절(2284행부터), 검토할 정책 P01부터 P11 |
...
## 5. A와 B 평가 허용 입력 (HR1) (2026-09-16 라운드 준비에서 해시 셋 갱신. 같은 날 앞서 T10 평가 대상 코드 행 기입)
...
| 실제 평가 기준 | harness/prompts/eval-criteria-code.md | sha256:bf11b34c286c52f2 | 축, 심각도, 출력 스키마. 프론트 축 여섯이 더해진 판(7절 D-2, 이슈 186. 2026-09-16 라운드 준비에서 갱신) |
| 대상이 참조하는 11 API 명세 | document/11-o2o-api-spec.md | sha256:9822c14edc59223f | 공통 절, API 32개 절, 응답 모델. 2026-09-16 PR 185 뒤 갱신(결제 승인의 시각 기준 여섯 자리. API 형태와 필드는 그대로) |
