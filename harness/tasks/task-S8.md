...
양식: harness/prompts/task-contract.md v2 (2026-09-08)
최초 작성: 2026-09-08
최종 갱신: 2026-09-08 (초안. 승인 대기)

이 계약은 초안이다. 승인 전에는 생성 단계로 넘어가지 않는다.
...
| 03 v12 | C-7 R4 문언 | R4 문언이 먼저 커밋되는 것과 확정 우선으로 교체. InventoryHoldRejected 추가는 09-1 미반입이라 미결로 표시 |
...
| 판 번호 | 로컬 현재 판에 1을 더한다 | 이 계약에서 결정. 승인 필요 |
| 04-5 반입 | project-sync v1을 입력으로 v2 후보 생성 | 이 계약에서 결정. 승인 필요 |
...
| 작업 계약 승인 | 미승인. 승인 대기 |
| 마지막 성공 단계 | 계약 초안 작성 |
| 미해결 사항과 다음 작업 | 판 번호와 04-5 반입 두 결정의 승인. 09-1 미반입으로 03의 이벤트 항목 하나가 미결 |
| 최종 산출물과 버전 | 작업 후 기록 |
| 실제 사용 시간 | 미측정 |
| 최종 완료 판단 | 미판단 |
