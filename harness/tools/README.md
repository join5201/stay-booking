...
| 파일 | 상태 |
|---|---|
| check.mjs | fill, g1, g2, answer, sweep 다섯 명령. 2026-09-08 H3에서 재작성, 같은 날 하네스 리뷰 12건 반영. 2026-09-10 sweep 추가 (10-14 8-4절) |
| build-v2.mjs | tmp/api-spec-v2/build-v2.mjs 사본. API 명세 조립용. 미검증 |
| tests/ | 골든 fixture 6개와 테스트 83건 (2026-09-10 실측). fixture는 harness/prompts/의 양식에서 만든다 |
...
g1과 g2와 sweep은 아무 파일도 쓰지 않는다. 읽기만 한다.
