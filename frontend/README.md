...
최초 작성: 2026-09-15
최종 갱신: 2026-09-25 (소개 문장의 범위에 컨테이너 이미지 배포. 결정 D1, 이슈 206. 그 전 2026-09-16 test:e2e 줄을 T10 뒤 실제대로. 2026-09-15 T2 공통 UI와 T1 기반)

O2O 숙박 예약 MVP의 화면이다. 로컬 개발과 검증, 컨테이너 이미지 배포까지 다룬다(2026-09-25 결정 D1). 작업 계약은 harness/tasks/task-S9-frontend.md이고 화면과 API 대응표는 그 2절이다.
