...
최초 작성: 2026-09-08
최종 갱신: 2026-09-16 (프론트 행. R1 평가 라운드 준비 PR 187 병합. 같은 날 앞서 T10 main 병합으로 프론트 열 단계 전부. 같은 날 앞서 T8과 T9 main 병합. 같은 날 앞서 T7 main 병합. 같은 날 앞서 T6 main 병합. 같은 날 앞서 프론트 행 둘. T1부터 T5 main 병합. 그 전 2026-09-10 파일 색인 신설. 문서와 그림을 링크로 잇는다)
