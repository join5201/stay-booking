...
최초 작성: 2026-09-08
최종 갱신: 2026-09-11 (6절을 묶음 7행 진척 표로. 이슈 129)
...
## 6. 지금 어디까지 왔나 (2026-09-11 묶음 표 신설)
...
|---|---|---|---|---|---|---|
| 숙소와 객실 | CAT-01~09 (9) | 9 | 0 | T01, T02 부분 통과. 남은 구간은 재고와 예약 몫 | 최종 승인 | progress.md 2026-09-09 16:55 |
| 재고와 요금 | INV-01~05, RATE-01~04 (9) | 9 | 0 | T03, T05 통과. T04, T06, T07 부분. held 몫은 예약 묶음에서 닫힘 | main 병합. Codex 2라운드는 MVP 뒤 | PR 115. progress.md 2026-09-11 16:33 |
| 프로모션과 검색 | PROMO-01~05, SEARCH-01~03 (8) | 0 | 8 | T12, T13, T27, T28 | 계약 승인. 코드 작성 중 | PR 98 |
| 예약과 선점 | BOOK-01~03, HoldInventory (4) | 0 | 4 | T08~T13, T29 | 계약 승인. 코드 작성 중 | PR 127. progress.md 2026-09-11 17:27 |
| 결제와 확정 | PAY-01~02, INTERNAL-01, ConfirmBooking (4) | 0 | 4 | T14~T23, T26 | 미착수 | 없음 |
| 취소와 만료 | BOOK-04, ExpireBooking, RefundPayment (3) | 0 | 3 | T17~T25 | 미착수. 예약 2차 몫 | 없음 |
| 접근 범위 | 로컬 행위자, 소유권, Mock 경로 (3) | 2 | 1 | T02 부분, T30 | 행위자와 소유권은 숙소 묶음에서 끝. Mock 경로는 결제 몫 | shared의 Actor 여섯 파일, catalog의 hostId 대조 |
| 합계 | 40 | 20 | 20 | 30 중 통과 2, 부분 5, 미착수 23 | 전체 대비 남음 50% | main 42cf9b3 기준 |

기능 수로는 반이지만 검증은 30 중 2만 온전히 닫혔다. 동시 예약, 멱등, 만료 경합 같은 어려운 시나리오가 뒤 세 묶음에 몰려 있어 남은 일은 반보다 많다.
