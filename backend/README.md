...
최초 작성: 2026-09-08
최종 갱신: 2026-09-12 (6절을 묶음 7행 진척 표로. 이슈 129. 표는 2026-09-12 main 기준)
...
## 6. 지금 어디까지 왔나 (2026-09-11 묶음 표 신설. 2026-09-12 main 기준으로 갱신)
...
| 결제와 확정 | PAY-01~02, INTERNAL-01, ConfirmBooking (4) | 0 | 4 | T14~T23, T26 | 계약 승인. 코드 작성 중 | PR 133(초안). 그 브랜치의 progress.md 2026-09-12 05:32 |
| 취소와 만료 | BOOK-04, ExpireBooking, RefundPayment (3) | 0 | 3 | T17~T25 | 미착수. 예약 2차 몫. 결제 PR 병합 뒤 | 없음 |
| 접근 범위 | 로컬 행위자, 소유권, Mock 경로 (3) | 2 | 1 | T02 통과, T30 | 행위자와 소유권은 숙소 묶음에서 끝. Mock 경로는 결제 몫 | shared의 Actor 여섯 파일, catalog의 hostId 대조 |
