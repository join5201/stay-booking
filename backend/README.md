...
## 6. 지금 어디까지 왔나 (2026-09-11 묶음 표 신설. 2026-09-12 main 기준으로 갱신. 2026-09-13 결제 행과 접근 범위 행. 같은 날 예약 2차 9단계로 세 행과 합계의 상태)
...
| 예약과 선점 | BOOK-01~03, HoldInventory (4) | 4 | 0 | T06~T11 통과. T12, T13 부분(요금 절반이 main. 프로모션 절반은 2차 브랜치에서 통과) | main 병합. 1차 done 행. 2차(결제 중계, 확정, 만료, 취소)는 사용자 최종 승인 2026-09-13 23:46. PR 138 병합은 이 행 뒤 | PR 127. progress.md 2026-09-12 04:37. 2차는 PR 138, progress.md 2026-09-13 23:37 |
| 결제와 확정 | PAY-01~02, INTERNAL-01, ConfirmBooking (4) | 1 | 3 | T21, T26 통과. T15~T17, T20, T22, T23 부분(결제 몫이 main). T14, T18, T19와 T15~T17, T20, T22, T23의 예약 몫은 2차 브랜치에서 통과 | main은 INTERNAL-01과 내부 처리(Mock 결제, 자동 결과, 재개, 이벤트 넷). PAY-01~02와 ConfirmBooking은 예약 2차로 사용자 최종 승인 2026-09-13 23:46. PR 138 병합은 이 행 뒤. 끝 칸은 main 병합 뒤 4 | PR 133 병합 8bd19a6. progress.md 2026-09-13 20:17. 2차는 PR 138, progress.md 2026-09-13 23:37 |
| 취소와 만료 | BOOK-04, ExpireBooking, RefundPayment (3) | 0 | 3 | T17~T20, T22, T24, T25, T29가 2차 브랜치에서 통과. T23 예약 몫은 6절 충돌 행 해석으로 통과(검증 표 1-9절) | 예약 2차로 사용자 최종 승인 2026-09-13 23:46. PR 138 병합은 이 행 뒤. 끝 칸은 main 병합 뒤 3 | PR 138. progress.md 2026-09-13 23:37 |
...
| 합계 | 40 | 34 | 6 | 30 중 통과 15, 부분 9, 미착수 6. 남음 6은 전부 PR 138 브랜치에서 검증 표까지 끝 | 전체 대비 남음 15%. PR 138 병합 뒤 0% | main 8bd19a6 기준. 브랜치 상태는 PR 138 |
