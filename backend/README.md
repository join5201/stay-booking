...
최초 작성: 2026-09-08
최종 갱신: 2026-09-13 (6절 예약과 선점 행, 결제와 확정 행, 취소와 만료 행, 합계의 상태. 예약 2차 9단계 검증 표, PR 138. B2. 그 전 같은 날 6절 결제와 확정 행, 접근 범위 행, 합계. 결제 묶음 PR 133 main 병합 8bd19a6. B2. 그 전 같은 날 6절 결제와 확정 행. 결제 묶음 사용자 최종 승인, PR 133 병합 지시. B2. 그 전 같은 날 6절 결제와 확정 행과 접근 범위 행. 결제 묶음 9단계 검증 표, PR 133. B2. 그 전 2026-09-12 6절을 묶음 7행 진척 표로, 이슈 129)
...
| 예약과 선점 | BOOK-01~03, HoldInventory (4) | 4 | 0 | T06~T11 통과. T12, T13 부분(요금 절반이 main. 프로모션 절반은 2차 브랜치에서 통과) | main 병합. 1차 done 행. 2차(결제 중계, 확정, 만료, 취소)는 브랜치에서 9단계 검증 표까지 끝, PR 138 검토 대기 | PR 127. progress.md 2026-09-12 04:37. 2차는 PR 138, progress.md 2026-09-13 23:37 |
| 결제와 확정 | PAY-01~02, INTERNAL-01, ConfirmBooking (4) | 1 | 3 | T21, T26 통과. T15~T17, T20, T22, T23 부분(결제 몫이 main). T14, T18, T19와 T15~T17, T20, T22, T23의 예약 몫은 2차 브랜치에서 통과 | main은 INTERNAL-01과 내부 처리(Mock 결제, 자동 결과, 재개, 이벤트 넷). PAY-01~02와 ConfirmBooking은 예약 2차 브랜치에서 9단계 검증 표까지 끝, PR 138 검토 대기. 끝 칸은 main 병합 뒤 4 | PR 133 병합 8bd19a6. progress.md 2026-09-13 20:17. 2차는 PR 138, progress.md 2026-09-13 23:37 |
| 취소와 만료 | BOOK-04, ExpireBooking, RefundPayment (3) | 0 | 3 | T17~T20, T22, T24, T25, T29가 2차 브랜치에서 통과. T23 예약 몫은 6절 충돌 행 해석으로 통과(검증 표 1-9절) | 예약 2차 브랜치에서 9단계 검증 표까지 끝, PR 138 검토 대기. 끝 칸은 main 병합 뒤 3 | PR 138. progress.md 2026-09-13 23:37 |
